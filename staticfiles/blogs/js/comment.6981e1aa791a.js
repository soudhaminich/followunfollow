...
function formatCommentElement(commented){
    ...
    "<a hred='#' onclick='commentReply(" +commented.id+ ",1);' id='reply-"+commented.id +"' style='color:blue'>&nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;Reply</a><textarea id='textarea-"+commented.id +"' style='display:none;'></textarea>"+
     "<button class='d-none btn btn-primary' type='submit' id='button-"+commented.id +"' >Reply</button></div>"
...
function commentReply(textareadId,setElement){
    ...
    if (setElement === 1) {
        ...
        buttonReplyComment.setAttribute('class','d-none btn btn-primary');
