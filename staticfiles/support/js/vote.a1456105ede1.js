    ...
    fetch(URL)
        ...
        .then((data) => {
            ...
            if (data.total_up_count) {
                OutputEl.innerText = data.total_up_count
                if (data.total_down_count === 0) {
                    OutputdownEl.innerText = ''
                }
                else {
                    OutputdownEl.innerText = data.total_down_count
                }
